<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        if($ok){
            $sql= "INSERT INTO `subjects`(`sbj_name`,`department`,`sbj_code`,`class`,`created`) VALUES(?,?,?,?,?)";
            ...
            if(!mysqli_stmt_prepare($stmt,$sql)){
                ...
                mysqli_stmt_bind_param($stmt,"sssss",$sbj_name,$department,$sbj_code,$class,$cur_time_stamp);
                if(mysqli_stmt_execute($stmt)){
                    $feedback = "Subject has been added successfully!";
                }
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <div class="form-group p-3">
                                ...
                                <input type="text" name="sbj_name" id="id_sbj_name" placeholder="Name" class="form-control" required>
                            </div>
                            <div class="form-group p-3">
                                <label for="id_sbj_code">Subject Code:</label>
                                <input type="text" name="sbj_code" id="id_sbj_code" placeholder="subject code" class="form-control" required>
                            </div>
                            <div class="form-group p-3">
