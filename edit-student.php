<?php 
    ...
    if(isset($_GET['action'])){
        ...
        if(isset($_POST['uid'])){
            ...
            if($ok){
                $sql= "UPDATE `students` SET `reg_no`=?,`full_name`=?,`class_code`=?,`department`=?,`class_name`=?,`gender`=? WHERE `id`=?";
                $stmt=mysqli_stmt_init($conn);
                if(!mysqli_stmt_prepare($stmt,$sql)){
                    ...
                    mysqli_stmt_bind_param($stmt,"sssssss",$reg_no,$full_name,$class_code,$department,$class_name,$gender,$pk);
                    if(mysqli_stmt_execute($stmt)){
                        $feedback = "Student has been updated successfully!";
                    }
                }
            }  
        }
            ...
            <div class="container mt-5">
                <form action="" method="post" class="col-md-8 mx-auto">
                    <div class="card card-primary">
                        <div class="card-header"><div class="card-title">Edit Student</div></div>
                        <div class="card-body">
                            ...
                            <div class="form-group p-3">
                                ...
                                <input type="text" name="reg_no" id="id_reg_no" placeholder="Adm" class="form-control" required value="<?php echo $reg_no; ?>">
                            </div>
                            <div class="form-group p-3">
                                <label for="id_class_code">Class Code:</label>
                                <input type="text" name="class_code" id="id_class_code" placeholder="class code" class="form-control" required value="<?php echo $class_code; ?>">
                            </div>
                            <div class="form-group p-3">
                            ...
                            <div class="form-group p-3">
                                ...
                                <input type="text" name="class_name" id="id_class_name" placeholder="Class" class="form-control" required value="<?php echo $class_name;?>">
                            </div>
                            <div class="form-group p-3">
