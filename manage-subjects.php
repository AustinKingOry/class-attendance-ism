<?php 
    ...
    if(isset($_GET['action'])){
        ...
        if($action=="delete" && ($id)!=''){
            $delSql = "DELETE FROM `subjects` WHERE `id`=?";
            ...
            if(!mysqli_stmt_prepare($stmt,$delSql)){
                ...
                if(mysqli_stmt_execute($stmt)){
                    $feedback = "Subject has been deleted successfully!";
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="add-subjects.php" class="btn btn-primary"><i class="fas fa-plus"></i> New Subject</a>
                        </div>
                    </div>
                    <div class="card-body">
                        <table class="display table table-striped table-bordered table-hover" id="main-table">
                            ...
                            if(mysqli_num_rows($result)>0){
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-tool btn-danger bi-trash2" onclick="confirmDeletion('manage-subjects.php?action=delete&id=<?php echo $uid;?>')"></button>
                                        <a href="edit-subject.php?action=edit&id=<?php echo $uid;?>" class="btn btn-tool btn-primary bi-pencil-square"></a>
                                    </td>
                                </tr>
                            <?php }}?>
                            </tbody>
